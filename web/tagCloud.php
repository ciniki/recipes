...
// Description
// -----------
// This function will return a list of recipes organized by date
//
// Arguments
// ---------
// ciniki:
...
// -------
//
function ciniki_recipes_web_tagCloud($ciniki, $settings, $business_id, $type) {
	...
	$strsql = "SELECT ciniki_recipe_tags.tag_name, "
		...
		. "";
	//
	// Get the list of recipes, sorted by publish_date for use in the web CI List Categories
	//
